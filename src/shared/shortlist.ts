const STORAGE_KEY = "sf-movies:shortlist";

// Parses the raw localStorage value into a list of shortlisted sourceUrls.
...
export function loadShortlist(): string[] {
  return parseShortlist(localStorage.getItem(STORAGE_KEY));
}
